...
\begin{resume}
    ...
    Seeking a full-time position as a programmer / IT professional beginning June 2015.
    ...
    \employer{JMA Energy Co.}
    \title{Geology Technician's Assistant}
    \dates{June 2009 - August 2009}
    \location{Oklahoma City, OK}
    \begin{position}
        \begin{itemize}
            \item Assisted the Geology Technician with the digitization and organization of various logs
        \end{itemize}
    \end{position}
...
%    \begin{compactitem}
		\item Programming Languages:  Python, Ruby, Java, C\#, C/C++, R, SML, LISP
